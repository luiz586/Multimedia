...
public:
  ...
  //distortion & PSNR
  uint64   calcSAD          (xCmp* ReferenceCmp);
  uint64   calcSATD         (xCmp* ReferenceCmp);
  uint64   calcSSD          (xCmp* ReferenceCmp);
  ...
  uint64   predict_4x4      (xCmp* Src);
  uint64   predict_8x8      (xCmp* Src);
  uint64   predict_16x16    (xCmp* Src);
  uint64   predict_32x32    (xCmp* Src);
  uint64   predict_64x64    (xCmp* Src);
