...
public:
  ...
  static void xAddContinuous_AVX           (int16* Dst, int16* Src0, int16* Src1, int32 Area);
  ...
  static void xAddAndClipContinuous_AVX    (int16* Dst, int16* Src0, int16* Src1, int32 Area, int16 ClippingRange);
  ...
  static void xSubContinuous_AVX           (int16* Dst, int16* Src0, int16* Src1, int32 Area);
  ...
  static void xBiPredRefEstContinuous_AVX  (int16* Dst, int16* Src0, int16* Src1, int32 Area);
  ...
  static void xAvgContinuous_AVX           (int16* Dst, int16* Src0, int16* Src1, int32 Area);
  ...
  static void xAvgAndClipContinuous_AVX    (int16* Dst, int16* Src0, int16* Src1, int32 Area, int16 ClippingRange);
  ...
  static void xClipContinuous_AVX          (int16* Dst, int16* Src, int32 Area, int16 ClippingRangeLow, int16 ClippingRangeHigh);
  ...
  static void xPackI16ToU8Continuous_STD   (uint8* Dst, int16* Src, int32 Area);
  static void xPackI16ToU8Continuous_SSE   (uint8* Dst, int16* Src, int32 Area);
  static void xPackI16ToU8Continuous_AVX   (uint8* Dst, int16* Src, int32 Area);
  static void xPackI16ToU8_STD             (uint8* Dst, int16* Src, int32 DstStride, int32 SrcStride, int32 Width, int32 Height);
  static void xPackI16ToU8_SSE             (uint8* Dst, int16* Src, int32 DstStride, int32 SrcStride, int32 Width, int32 Height);

  static void xUnpackU8ToI16Continuous_STD (int16* Dst, uint8* Src, int32 Area);
  static void xUnpackU8ToI16Continuous_SSE (int16* Dst, uint8* Src, int32 Area);
  static void xUnpackU8ToI16Continuous_AVX (int16* Dst, uint8* Src, int32 Area);
  static void xUnpackU8ToI16_STD           (int16* Dst, uint8* Src, int32 DstStride, int32 SrcStride, int32 Width, int32 Height);
  static void xUnpackU8ToI16_SSE           (int16* Dst, uint8* Src, int32 DstStride, int32 SrcStride, int32 Width, int32 Height);
  
//=========================================================================================================================================

#if X_USE_AVX && X_AVX2
  static void AddContinuous             (int16* Dst, int16* Src0, int16* Src1, int32 Area) { xAddContinuous_AVX(Dst, Src0, Src1, Area); }
  ...
  static void AddAndClipContinuous      (int16* Dst, int16* Src0, int16* Src1, int32 Area, int16 ClippingRange) { xAddAndClipContinuous_AVX(Dst, Src0, Src1, Area, ClippingRange); }
  ...
  static void SubContinuous             (int16* Dst, int16* Src0, int16* Src1, int32 Area) { xSubContinuous_AVX(Dst, Src0, Src1, Area); }
  ...
  static void BiPredRefEstContinuous    (int16* Dst, int16* Src0, int16* Src1, int32 Area) { xBiPredRefEstContinuous_AVX(Dst, Src0, Src1, Area); }
  ...
  static void AvgContinuous             (int16* Dst, int16* Src0, int16* Src1, int32 Area) { xAvgContinuous_AVX(Dst, Src0, Src1, Area); }
  ...
  static void AvgAndClipContinuous      (int16* Dst, int16* Src0, int16* Src1, int32 Area, int16 ClippingRange) { xAvgAndClipContinuous_AVX(Dst, Src0, Src1, Area, ClippingRange); }
  ...
  static void ClipContinuous            (int16* Dst, int16* Src, int32 Area, int16 ClippingRangeLow, int16 ClippingRangeHigh) { xClipContinuous_AVX(Dst, Src, Area, ClippingRangeLow, ClippingRangeHigh); }
  ...
  static void PackI16ToU8Continuous     (uint8* Dst, int16* Src, int32 Area) { xPackI16ToU8Continuous_AVX(Dst, Src, Area); }
  static void PackI16ToU8               (uint8* Dst, int16* Src, int32 DstStride, int32 SrcStride, int32 Width, int32 Height) { xPackI16ToU8_SSE(Dst, Src, DstStride, SrcStride, Width, Height); }
  static void UnpackU8ToI16Continuous   (int16* Dst, uint8* Src, int32 Area) { xUnpackU8ToI16Continuous_AVX(Dst, Src, Area); }
  static void UnpackU8ToI16             (int16* Dst, uint8* Src, int32 DstStride, int32 SrcStride, int32 Width, int32 Height) { xUnpackU8ToI16_SSE(Dst, Src, DstStride, SrcStride, Width, Height); }
  ...
  static void Clip                      (int16* Dst, int16* Src, int32 DstStride, int32 SrcStride, int32 Width, int32 Height, int16 ClippingRangeLow, int16 ClippingRangeHigh) { xClip_SSE(Dst, Src, DstStride, SrcStride, Width, Height, ClippingRangeLow, ClippingRangeHigh); }
  static void PackI16ToU8Continuous     (uint8* Dst, int16* Src, int32 Area) { xPackI16ToU8Continuous_SSE(Dst, Src, Area); }
  static void PackI16ToU8               (uint8* Dst, int16* Src, int32 DstStride, int32 SrcStride, int32 Width, int32 Height) { xPackI16ToU8_SSE(Dst, Src, DstStride, SrcStride, Width, Height); }
  static void UnpackU8ToI16Continuous   (int16* Dst, uint8* Src, int32 Area) { xUnpackU8ToI16Continuous_SSE(Dst, Src, Area); }
  static void UnpackU8ToI16             (int16* Dst, uint8* Src, int32 DstStride, int32 SrcStride, int32 Width, int32 Height) { xUnpackU8ToI16_SSE(Dst, Src, DstStride, SrcStride, Width, Height); }
#else
  ...
  static void PackI16ToU8Continuous     (int8*  Dst, int16* Src, int32 Area) { xPackI16ToU8Continuous_STD(Dst, Src, Area); }
  static void PackI16ToU8               (int8*  Dst, int16* Src, int32 DstStride, int32 SrcStride, int32 Width, int32 Height) { xPackI16ToU8_STD(Dst, Src, DstStride, SrcStride, Width, Height); }
  static void UnpackU8ToI16Continuous   (int16* Dst, int8*  Src, int32 Area) { xUnpackU8ToI16Continuous_STD(Dst, Src, Area); }
  static void UnpackU8ToI16             (int16* Dst, int8*  Src, int32 DstStride, int32 SrcStride, int32 Width, int32 Height) { xUnpackU8ToI16_STD(Dst, Src, DstStride, SrcStride, Width, Height); }
#endif
